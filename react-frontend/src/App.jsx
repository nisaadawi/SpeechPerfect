...
import SettingSelection from "./pages/SettingSelection";
import HecklerSelection from "./pages/HecklerSelection";
import StartGame from "./pages/StartGame";
import GameView from "./pages/GameView";
import { GameSetupProvider } from "./context/GameSetupContext";

function Home() {
  // Flask integration temporarily disabled to avoid backend load while editing the UI.
      ...
      >
        ...
        >
          ...
          <div style={{ color: "#b0b0b0", lineHeight: 1.5 }}>
            Live video feed disabled while Flask backend is paused.
          </div>
        </div>
      </div>
    </div>
